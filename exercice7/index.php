<html>
    <head>
        ...
        <!--Traduire ce code avec des if et des else :
            <php echo ($maVariable == false) ? 'c\'est pas bon !!!' : 'c\'est ok !!'; ?> -->
        <title>Exercice 7 de la partie 2 en PHP</title>
    </head>
    <body>
        <!--Mise en place d'une balise p pour mettre le script php-->
        <p>
            <?php
// Déclaration de la variable response
            $response = true;
// Mise en place de la structure if...else avec utilisation du symbole Égal à            
            if ($response == false){
